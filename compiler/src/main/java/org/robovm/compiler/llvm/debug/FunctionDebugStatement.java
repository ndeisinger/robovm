...
public class FunctionDebugStatement extends DebugStatement {
	...
	/**
	 * Returns the LLVM metadata block for this function.
	 * For further reference, see http://llvm.org/docs/SourceLevelDebugging.html#subprogram-descriptors
	 */
	public String toString()
	{
		...
		sb.append("metadata !" + typeRef + ", "); //Return type - set to dummy type for now
		
		//TODO: Set these flags appropriately.
		sb.append("i1 false, "); //True if global is local to compile unit
		sb.append("i1 true, "); //True if the global is defined in the compile unit (not extern)
		sb.append("i32 0, "); //Virtuality, e.g. dwarf::DW_VIRTUALITY__virtual
		sb.append("i32 0, "); //Index into a virtual function
		sb.append("null, "); //indicates which base type contains the vtable pointer for the derived class
		sb.append("i32 0, "); //Flags - Artifical, Private, Protected, Explicit, Prototyped.
		sb.append("i1 false, "); //Is optimized
		//End todo
		
		sb.append(funcPointer + ", "); //Function pointer for LLVM debug info
		sb.append("null, null, "); //TODO: Function template parameters, function declaration descriptor.
		sb.append("metadata !" + nullRef + ", "); //List of function variables.  Leave null for now.
