...
public class CompileUnitDebugStatement extends DebugStatement {
    ...
    public CompileUnitDebugStatement(int reference, int line, int contextRef,
            int subprogramListRef, int nullRef) {
        ...
        sb.append("metadata ! \"RoboVM version 0.0.6\", "); // Compiler version;
                                                            // TODO: get
                                                            // appropriate
                                                            // version rather
                                                            // than hard-code
        ...
        sb.append("metadata !" + subprogramListRef + ", "); // List of
                                                            // subprograms
