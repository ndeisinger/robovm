...
public class Function {
    ...
    public Function(Linkage linkage, FunctionAttribute[] attributes, String section, String name, FunctionType type, String ... parameterNames) {
        ...
        this.debugRef = DebugManager.getFuncRef(this);
    }
    ...
    /**
     * For LLVM debug info.  Returns the appropriate LLVM function pointer.
     * @return
     */
    public String getFunctionPointer()
    {
        ...
        Type[] parameterTypes = type.getParameterTypes();
        StringBuilder sb = new StringBuilder();
        //TODO: Not sure if this linkage should be included.
        /*
        if (linkage != null) {
            sb.append(linkage);
            sb.append(' ');
